...
export class Vector {
    ...
    /**
     * Creates a new Vector instance from the provided magnitude and angle.
     * @param magnitude - The magnitude of the vector.
     * @param angle - The angle of the vector in radians.
     * @returns A new Vector instance.
     */
    static fromMagnitudeAndAngle(magnitude: number, angle: number): Vector {
        return new Vector(
     ...
     * @param pivot - The pivot point to rotate around.
     * @param angle - The angle to rotate the vector by.
     * @returns The rotated Vector instance.
     */
    public rotate(pivot: Vector, radians: number): Vector {
        ...
        let newX = x * cos - y * sin;
        let newY = x * sin + y * cos;
        this.set(newX + pivot.x, newY + pivot.y);
        return this;
    }

    public connect({ x, y }: Vector): Vector {
        return this.subtract({ x, y } as Vector).reverse();
    }
}
